...
- (void)buttonPressed:(UIButton *)sender;
{
    ...
    int wholeWhiskeyShots = ceilf(numberOfWhiskeyGlassesForEquivalentAlcoholAmount);
    NSString *titleText = [NSString stringWithFormat:NSLocalizedString(@"Whiskey (%d %@)", nil), wholeWhiskeyShots, whiskeyText];
